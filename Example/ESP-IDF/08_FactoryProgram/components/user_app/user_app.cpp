...
BatteryMonitor batt_dev(ADC_CHANNEL_0,2,1);
...
void user_app_init(void) {
	...
	user_button_init();
	audio_dev = new I2sAudioCodec("C6_AMOLED_1_32");
}
...
void user_ui_init(void) {
	...
	xTaskCreatePinnedToCore(Custom_AudioLoopTask, "Custom_AudioLoopTask", 4 * 1024, NULL, 2, NULL,0);
